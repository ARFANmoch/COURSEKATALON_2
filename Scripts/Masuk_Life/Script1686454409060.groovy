...
WebUI.setText(findTestObject('Object Repository/Page_My Account  Lifechangers/input__username'), GlobalVariable.Username)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_My Account  Lifechangers/input__password'), GlobalVariable.Password)
