...
WebUI.openBrowser('')
	...
	//for (def rowNum=1; rowNum <=findTestData("Life/LiseUser").getRowNumbers(); rowNum++) {
		...
		WebUI.setText(findTestObject('Object Repository/Page_My Account  Lifechangers/input__username'), 'mcharfnn@gmail.com')

		WebUI.setEncryptedText(findTestObject('Object Repository/Page_My Account  Lifechangers/input__password'), 'MG57uhWAPTj38XXpmmrHxQ==')
