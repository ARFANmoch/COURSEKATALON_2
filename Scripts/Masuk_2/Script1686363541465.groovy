...
for (int i = 0; i < 2; i++) {
	...
	WebUI.setText(findTestObject('Object Repository/Page_My Account  Lifechangers/input__username'), findTestData("Life/LiseUser").getValue(1,1))

	WebUI.setEncryptedText(findTestObject('Object Repository/Page_My Account  Lifechangers/input__password'), findTestData("Life/LiseUser").getValue(2,1))
